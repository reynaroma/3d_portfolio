    ...
    <section className='relative w-full h-screen mx-auto'>
      ...
      top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          text-white`}>Hi, I&lsquo;m <span
              className='text-[#915eff]'>Reyna</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I am a Software Developer. <br className='sm:block hidden' /> I develop user interfaces and web applications
          </p>
        </div>
      </div>
      <ComputersCanvas />
